...
<body>
    ...
    <div class="title">
    <h1>BLOOD BANK</h1>
    <h3>Fill the below details and submit a request</h3>
    </div>
    ...
    <label for="">First Name</label>
        ...
        <input type="submit" value="Submit a request" name="submit">
    </form></div>
    <?php
        if(isset($_POST['submit'])){
            ...
            $q=$db->prepare("INSERT INTO requests (fname,lname,phnumber,bgroup,age,gender) values(:fname,:lname,:phnumber,:bgroup,:age,:gender)");
